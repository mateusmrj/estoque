...
<div class="container theme-showcase" role="main">
  ...
  <div class="row">
	<div class="col-md-12">
	  <form class="form-horizontal" method="POST" action="processa/proc_retira_produto.php" enctype="multipart/form-data">
			<div row>
			...
			<div class="col-sm-10">
				<input type="hidden" class="form-control" name="qtdeAtual" style="width: 20%;" placeholder="Quantidade" value="<?php echo $resultado['qtde']; ?>">
			</div>
			</div>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="number" class="form-control" name="qtde" style="width: 20%;" placeholder="Quantidade" value="<?php echo $resultado['qtde']; ?>">
			</div>
		  </div>
